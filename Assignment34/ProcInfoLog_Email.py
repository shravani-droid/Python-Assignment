# Desgin automation script which accepts the directory name and mail id from the user and create  log file in that directory 
# which contains information of running process as its name,PID ,Username. After creating log file to the specified mail.
...
def main():
    ...
    sender_email = "shraab317@gmail.com"
    app_password =  "JaiGanesh@0209"
    ...
    print("Automated Mail Sent Sucessfully")
    ...
    if(len(sys.argv) == 2):
        ...
        PlatformSurvellience(sys.argv[1],sys.argv[2])
